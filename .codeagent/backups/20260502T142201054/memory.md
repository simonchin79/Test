...
## Recent Changes
- **2026-05-02**: Fixed crash (macOS 26.4.1 Apple Silicon). QSGRenderThread crashes with EXC_BAD_ACCESS when rendering emoji glyphs (CoreText→ImageIO not thread-safe). Fixed by setting QSG_RENDER_LOOP=basic in main.cpp.
